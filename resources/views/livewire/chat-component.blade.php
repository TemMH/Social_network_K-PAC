...
<div class="message_history_author_background">
    ...
    <form id="sendMessageForm" wire:submit="sendMessage()" class="message_history_input">
        @csrf
        <div class="message_history_input_search_container">
            <input type="text" wire:model="message" id="message" type="text" name="message" required autofocus
                autocomplete="message" class="message_history_input_container" placeholder="Напишите сообщение...">
        </div>
