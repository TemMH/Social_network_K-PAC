                                ...
                                @foreach ($friends as $friend)
                                    <div class="friend-item">
                                        <label class='radio-label'>
                                            <input wire:click="$set('user_id', {{ $friend->id }})" type='radio'
                                                name='friend' value="{{ $friend->id }}" wire:model="user_id">
                                        ...
                                        @elseif ($user_id === $friend->id)
                                            <button wire:click="sendStatementToFriend"
                                                class="long_button">Отправить</button>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
