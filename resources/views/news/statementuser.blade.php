                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('.like-button, .unlike-button').click(function(e) {
                            ...
                            @php
                            $hasComplaint = auth()->check() && \App\Models\Complaint::hasComplaintStatement($statement->id, auth()->id());
                        @endphp
                    ...
                    <div class="full_statement_content_statement_top">
                        <div>
                            ...
                            <div class="full_statement_content_statement_top_created">
                             ...
                             <p>                        <div style="width: 5%;" class="statement_block_top_info_right">
